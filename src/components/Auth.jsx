...
───────────────────────────────────────────── */
export const Auth = () => {
  const { isAuthModalOpen, closeAuthModal, signIn, signUp, signInWithGoogle } = useAuthStore();
          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 2, padding: '36px 32px 32px' }}>
              ...
              >
                ...
                <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.2)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>or use email</span>
                <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,0.07)' }} />
              </div>
